...
BlocklyDuino.bindFunctions = function() {
	...
	$('#btn_turtle').on('click', function(){
		window.open("turtle/index.html","_blank", null);
	});
...
BlocklyDuino.theme_monokai = function () {
	...
	document.getElementById("btn_turtle").className = document.getElementById("btn_turtle").className.replace( /(?:^|\s)btn-default(?!\S)/g , ' btn-secondary' );
};
BlocklyDuino.theme_sqlserver = function () {
	...
	document.getElementById("btn_turtle").className = document.getElementById("btn_turtle").className.replace( /(?:^|\s)btn-secondary(?!\S)/g , ' btn-default' );
};
